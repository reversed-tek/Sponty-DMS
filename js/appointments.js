...
class AppointmentManager {
    ...
    showAddForm() {
        window.dispatchEvent(new CustomEvent('navigate', { detail: { page: 'appointment-add' } }));
    }

    viewAppointment(id) {
        window.dispatchEvent(new CustomEvent('navigate', { detail: { page: 'appointment-view', id: id } }));
    }

    editAppointment(id) {
        window.dispatchEvent(new CustomEvent('navigate', { detail: { page: 'appointment-edit', id: id } }));
    }
